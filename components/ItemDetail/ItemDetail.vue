<template>
  <!-- Start -->
        <div class="relative pt-28 md:pb-24 pb-16">
            <div class="container">
                    ...
                    <div class="lg:col-span-5">
                        ...
                        <div class="bg-gray-50 dark:bg-slate-800 rounded-md shadow dark:shadow-gray-800 mt-[30px] p-6">
                            <div>
                                ...
                                <a href="" class="font-medium text-violet-600 underline block">1fsvtgju51ntgeryimghf6ty7o9n3r3er246</a>
                            </div>
                                ...
                                <div class="" id="wednesday" role="tabpanel" aria-labelledby="wednesday-tab">
                                    <div class="grid grid-cols-1">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                <h6 class="font-semibold">2 WETH <span class="text-slate-400">by</span> <a href="" class="hover:text-violet-600 duration-500 ease-in-out">0xe849fa28a...ea14</a></h6>
                                        ...
                                        <div class="flex items-center mt-4">
                                            ...
                                            <div class="ml-3">
                                                <h6 class="font-semibold">0.001 WETH <span class="text-slate-400">by</span> <a href="" class="hover:text-violet-600 duration-500 ease-in-out">VOTwear</a></h6>
                                                <span class="text-slate-400 text-[16px]">6 hours ago</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-center mt-4">
                                            ...
                                            <div class="ml-3">
                                                <h6 class="font-semibold">1.225 WETH <span class="text-slate-400">by</span> <a href="" class="hover:text-violet-600 duration-500 ease-in-out">PandaOne</a></h6>
                                                <span class="text-slate-400 text-[16px]">6 hours ago</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1">
                                        <div class="flex items-center">
                                            ...
                                            <span class="content ml-3">
                                                <a href="" class="hover:text-violet-600 font-semibold block">Digital Art Collection</a>
                                                <span class="text-slate-400 block text-[16px] mt-1">Started Following <a href="" class="font-semibold hover:text-violet-600">@Panda</a></span>
        ...
        <!-- Start Modal -->
        <div id="NftBid" tabindex="-1" class="fixed z-50 hidden overflow-hidden inset-0 m-auto">
            <div class="relative w-full h-auto max-w-md p-4">
                <div class="relative bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800">
                    <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="NftBid">
                    ...
                    <div class="p-6">
                        <form class="text-left">
                            <div class="grid grid-cols-1">
                                <div class="mb-4">
                                    ...
                                    <input name="etherium" id="number" type="number" class="form-input mt-3 rounded-full" placeholder="00.00 ETH">
                                </div>

                                <div class="mb-4">
                                    <label class="font-semibold" for="number2">Enter Your QTY:</label>
                                    <input name="quantity" id="number2" type="number" class="form-input mt-3 rounded-full" placeholder="0">
                        ...
                        <div class="mt-4">
                            <a href="javascript:void(0)" data-modal-toggle="NftBid" class="btn rounded-full bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white w-full"><i class="mdi mdi-gavel"></i> Place a Bid</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="NftBuynow" tabindex="-1" class="fixed z-50 hidden overflow-hidden inset-0 m-auto">
            <div class="relative w-full h-auto max-w-md p-4">
                <div class="relative bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800">
                    <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                        <h5 class="text-xl font-semibold">Checkout</h5>
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="NftBuynow">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>  
                        </button>
                    </div>
                    <div class="p-6">
                        <form class="text-left">
                            <div class="grid grid-cols-1">
                                <div class="mb-4">
                                    ...
                                    <input name="etherium" id="number3" type="number" class="form-input mt-3 rounded-full" placeholder="00.00 ETH">
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="mt-4">
                            <a href="javascript:void(0)" data-modal-toggle="NftBuynow" class="btn rounded-full bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white w-full"><i class="mdi mdi-lightning-bolt"></i> Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
