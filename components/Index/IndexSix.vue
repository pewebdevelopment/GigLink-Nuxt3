                ...
                <div class="grid grid-cols-1 relative">
                    <div class="tiny-five-item">
                        <div class="tiny-slide">
                            <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 h-fit m-2">
        ...
        <div class="relative md:py-24 py-16">
            ...
            <div class="container md:mt-24 mt-16">
                ...
                <div class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-12 gap-[30px]">
                    <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500">
                    ...
                    <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500">
                        <img src="assets/images/items/7.jpg" class="rounded-lg" alt="">

                        <div class="relative p-4 -mt-14">
                            <div class="relative inline-block">
                                <img src="assets/images/avatar/7.jpg" class="h-16 rounded-md shadow-md dark:shadow-gray-800" alt="">
                                <i class="mdi mdi-check-decagram text-emerald-600 text-2xl absolute -bottom-3 -right-2"></i>
                            </div>

                            <div class="mt-3">
                                <a href="explore-one.html" class="font-semibold block text-[18px] hover:text-violet-600">Virtual Reality Collection</a>
                                <span class="text-slate-400 mt-1 text-sm"><span class="italic">by</span> <a href="creator-profile.html" class="text-violet-600 font-medium">@Princess</a></span>
                                <span class="text-slate-400 block text-[16px] mt-1">25 Items</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500">
                        <img src="assets/images/items/8.gif" class="rounded-lg" alt="">

                        <div class="relative p-4 -mt-14">
                            <div class="relative inline-block">
                                <img src="assets/images/avatar/8.jpg" class="h-16 rounded-md shadow-md dark:shadow-gray-800" alt="">
                                <i class="mdi mdi-check-decagram text-emerald-600 text-2xl absolute -bottom-3 -right-2"></i>
                            </div>

                            <div class="mt-3">
                                <a href="explore-one.html" class="font-semibold block text-[18px] hover:text-violet-600">Cartoon Collection</a>
                                <span class="text-slate-400 mt-1 text-sm"><span class="italic">by</span> <a href="creator-profile.html" class="text-violet-600 font-medium">@LooserBad</a></span>
                                <span class="text-slate-400 block text-[16px] mt-1">25 Items</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-12 gap-[30px]">
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        <div class="relative overflow-hidden">
                            ...
                            <div class="absolute bottom-2 right-0 left-0 mx-auto text-center bg-gradient-to-r from-violet-600 to-red-600 text-white inline-table text-lg px-3 rounded-full">
                                <i class="uil uil-clock align-middle mr-1"></i> <small id="auction-item-2" class="font-bold"></small>
                            </div>
                        </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        <div class="relative overflow-hidden">
                            ...
                            <div class="absolute bottom-2 right-0 left-0 mx-auto text-center bg-gradient-to-r from-violet-600 to-red-600 text-white inline-table text-lg px-3 rounded-full">
                                <i class="uil uil-clock align-middle mr-1"></i> <small id="auction-item-3" class="font-bold"></small>
                            </div>
                        </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        <div class="relative overflow-hidden">
                            ...
                            <div class="absolute bottom-2 right-0 left-0 mx-auto text-center bg-gradient-to-r from-violet-600 to-red-600 text-white inline-table text-lg px-3 rounded-full">
                                <i class="uil uil-clock align-middle mr-1"></i> <small id="auction-item-4" class="font-bold"></small>
                            </div>
                        </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        <div class="relative overflow-hidden">
                            ...
                            <div class="absolute bottom-2 right-0 left-0 mx-auto text-center bg-gradient-to-r from-violet-600 to-red-600 text-white inline-table text-lg px-3 rounded-full">
                                <i class="uil uil-clock align-middle mr-1"></i> <small id="auction-item-6" class="font-bold"></small>
                            </div>
                        </div>
            ...
            <div class="container md:mt-24 mt-16">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-12 gap-[30px]">
