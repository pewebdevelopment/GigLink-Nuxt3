<template>
  <!-- Start -->
    <div class="relative lg:pt-24 pt-[74px] overflow-hidden">
        <div class="container-fluid lg:px-10 md:px-3 relative overflow-hidden">
            <span class="absolute blur-[200px] w-[600px] h-[600px] rounded-full top-1/2 -translate-x-1/2 left-1/2 -translate-y-1/2 bg-gradient-to-tl from-red-600/40 to-violet-600/40 dark:from-red-600/60 dark:to-violet-600/60"></span>
                    ...
                    <div class="container">
                        <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                            <div class="md:col-span-7">
                                <div class="md:mr-6">
                                    <h4 class="font-bold lg:leading-snug leading-snug text-4xl lg:text-6xl mb-4"><span class="bg-gradient-to-l from-red-600 to-violet-600 text-transparent bg-clip-text">Buy, sell,</span>    and <br> showcase NFTs</h4>
                                    <p class="text-lg max-w-xl">We are a huge marketplace dedicated to connecting great artists of all Giglink with their fans and unique token collectors!</p>
                                
                                    <div class="mt-6">
                                        <a href="explore-two.html" class="btn bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-full mr-2 mt-2">Explore Now</a>
                                        <a href="upload-work.html" class="btn bg-transparent hover:bg-violet-600 border-violet-600 text-violet-600 hover:text-white rounded-full mt-2">Sell Now</a>
                                    </div>
                                </div>
                                            ...
                                            <a href="item-detail.html" class="group relative overflow-hidden rounded-lg">
                                                ...
                                                <span class="absolute bottom-5 left-5">
                                                    <span class="mb-2 block">
                                                        <span class="font-semibold text-white">Genuine Undead #3902</span>
                                                    </span>
                                                    
                                                    <span class="flex items-center">
                                                        <img src="assets/images/avatar/1.jpg" class="rounded-full h-8 w-8" alt="">
                                                        <span class="ml-2 text-[15px] font-medium text-white">@StreetBoy</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="tiny-slide">
                                        <div class="m-2 p-3 bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800">
                                            <a href="item-detail.html" class="group relative overflow-hidden rounded-lg">
                                                ...
                                                <span class="absolute bottom-5 left-5">
                                                    <span class="mb-2 block">
                                                        <span class="font-semibold text-white">Windchime #768</span>
                                                    </span>
                                                    
                                                    <span class="flex items-center">
                                                        <img src="assets/images/avatar/2.jpg" class="rounded-full h-8 w-8" alt="">
                                                        <span class="ml-2 text-[15px] font-medium text-white">@CutieGirl</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="tiny-slide">
                                        <div class="m-2 p-3 bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800">
                                            <a href="item-detail.html" class="group relative overflow-hidden rounded-lg">
                                                ...
                                                <span class="absolute bottom-5 left-5">
                                                    <span class="mb-2 block">
                                                        <span class="font-semibold text-white">Probably A Label #3277</span>
                                                    </span>
                                                    
                                                    <span class="flex items-center">
                                                        <img src="assets/images/items/3.gif" class="rounded-full h-8 w-8" alt="">
                                                        <span class="ml-2 text-[15px] font-medium text-white">@ButterFly</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="tiny-slide">
                                        <div class="m-2 p-3 bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800">
                                            <a href="item-detail.html" class="group relative overflow-hidden rounded-lg">
                                                ...
                                                <span class="absolute bottom-5 left-5">
                                                    <span class="mb-2 block">
                                                        <span class="font-semibold text-white">Probably A Label #1711</span>
                                                    </span>
                                                    
                                                    <span class="flex items-center">
                                                        <img src="assets/images/avatar/3.jpg" class="rounded-full h-8 w-8" alt="">
                                                        <span class="ml-2 text-[15px] font-medium text-white">@NorseQueen</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="tiny-slide">
                                        <div class="m-2 p-3 bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800">
                                            <a href="item-detail.html" class="group relative overflow-hidden rounded-lg">
                                                ...
                                                <span class="absolute bottom-5 left-5">
                                                    <span class="mb-2 block">
                                                        <span class="font-semibold text-white">Shibuya Scramble Punks</span>
                                                    </span>
                                                    
                                                    <span class="flex items-center">
                                                        <img src="assets/images/avatar/4.jpg" class="rounded-full h-8 w-8" alt="">
                                                        <span class="ml-2 text-[15px] font-medium text-white">@BigBull</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="tiny-slide">
                                        <div class="m-2 p-3 bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800">
                                            <a href="item-detail.html" class="group relative overflow-hidden rounded-lg">
                                                ...
                                                <span class="absolute bottom-5 left-5">
                                                    <span class="mb-2 block">
                                                        <span class="font-semibold text-white">Probably A Label #650</span>
                                                    </span>
                                                    
                                                    <span class="flex items-center">
                                                        <img src="assets/images/avatar/5.jpg" class="rounded-full h-8 w-8" alt="">
                                                        <span class="ml-2 text-[15px] font-medium text-white">@Angel</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </div>
                ...
                <div class="md:flex justify-between items-center">
                    <div class="md:w-10/12 md:text-left text-center">
                        <h3 class="md:text-[30px] text-[26px] font-semibold mb-4">Best Creators & Sellers of 
                            <select class="form-select z-2 text-violet-600 focus-visible:outline-none bg-transparent" aria-label="Default select example">
            ...
            <div class="container md:mt-24 mt-16">
                ...
                <div class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-10 gap-[30px]">
                    <div class="group relative p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 h-fit">
                        <div class="absolute inset-0 bg-gradient-to-r from-red-600 to-violet-600 rounded-lg -mt-1 group-hover:-mt-2 -ml-1 group-hover:-ml-2 h-[98%] w-[98%] -z-1 transition-all duration-500"></div>
