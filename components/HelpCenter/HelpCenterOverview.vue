        ...
        <div class="relative table w-full py-36 bg-[url('../../assets/images/bg/bg1.jpg')] bg-bottom bg-no-repeat">
            ...
            <div class="container">
                <div class="grid grid-cols-1 pb-8 text-center mt-10">
                    <h3 class="mb-6 md:text-4xl text-3xl md:leading-snug leading-snug font-semibold text-white">Hello ! <br> How can we help you?</h3>

                    <div class="text-center subcribe-form mt-4 pt-2">
                        <form class="relative mx-auto max-w-xl">
                            <input type="text" id="help" name="name" class="pt-4 pr-40 pb-4 pl-6 w-full h-[50px] outline-none text-slate-900 dark:text-white rounded-full bg-white/70 dark:bg-slate-900/70 shadow dark:shadow-gray-800" placeholder="Search your questions or topic...">
                            <button type="submit" class="btn absolute top-[2px] right-[3px] h-[46px] bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-full">Search</button>
                        </form><!--end form-->
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
            ...
            <div class="absolute text-center z-10 bottom-5 right-0 left-0 mx-3">
                <ul class="breadcrumb tracking-[0.5px] breadcrumb-light mb-0 inline-block">
                   <li class="inline breadcrumb-item text-[15px] font-semibold duration-500 ease-in-out text-white/50 hover:text-white"><a href="index.html">Giglink</a></li>
                    <li class="inline breadcrumb-item text-[15px] font-semibold duration-500 ease-in-out text-white" aria-current="page">Helpcenter</li>
                </ul>
            </div>
        </div><!--end div-->
        <div class="relative">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-6 gap-[30px]">
                    <div class="text-center px-6 mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="helpcenter-faqs.html" class="title h5 text-lg font-semibold hover:text-violet-600">FAQs</a>
                    ...
                    <div class="text-center px-6 mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="helpcenter-guides.html" class="title h5 text-lg font-semibold hover:text-violet-600">Guides / Support</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    ...
                    <div class="text-center px-6 mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="helpcenter-support.html" class="title h5 text-lg font-semibold hover:text-violet-600">Support Request</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
