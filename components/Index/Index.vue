<template>
  <!-- Start Hero -->
  <div class="relative md:pt-48 pt-36 overflow-hidden">
    <div class="container">
      <div class="grid grid-cols-1 justify-center text-center mt-10">
        <div class="relative">
          <div class="relative mb-5">
            ...
            <div
              class="
                ...
                after:h-10
                after:w-10
                after:bg-violet-600/10
                dark:after:bg-violet-600/30
                after:-top-[50px]
                after:left-[30%]
                after:-z-1
                after:rounded-lg
            ...
            <div
              class="
                ...
                after:h-10
                after:w-10
                after:bg-violet-600/20
                dark:after:bg-violet-600/40
                after:bottom-[0]
                after:right-[15%]
                after:-z-1
                after:rounded-full
          ...
          <p class="text-slate-400 dark:text-white/70 text-lg max-w-xl mx-auto">
              ...
              <div class="relative p-4 -mt-14">
                <div class="relative inline-block">
                  <img
                    ...
                    class="h-16 rounded-md shadow-md dark:shadow-gray-800"
                    alt=""
                  />
                  <i
                    class="
                ...
                <div class="mt-3">
                  ...
                  >
                  <span class="text-slate-400 mt-1 text-sm"
                    ...
                    ></span
                  >
                  <span class="text-slate-400 block text-[16px] mt-1"
                    >25 Items</span
                  >
                </div>
              </div>
  ...
  <div class="relative md:py-24 py-16">
      ...
      >
        ...
        >
            ...
            >
              <a
                ...
                class="
                  ...
                  text-white
                "
                ><i class="mdi mdi-lightning-bolt"></i> Buy Now</a
              >
            </div>
          ...
          <div class="mt-3">
            ...
            >
              <div>
                <span class="text-[16px] font-medium text-slate-400 block"
                  >Price</span
                >
                <span class="text-[16px] font-semibold block"
                  ><i class="mdi mdi-ethereum"></i> 3.5 ETH</span
                >
              </div>
              ...
              <div>
                ...
                >
                <span class="text-[16px] font-semibold block"
                  ><i class="mdi mdi-ethereum"></i> 3.55 ETH</span
                >
              </div>
            </div>
          </div>
        ...
        >
          <div class="relative overflow-hidden">
            ...
            <div
              ...
              "
            >
              <i class="uil uil-clock align-middle mr-1"></i>
              <small id="auction-item-1" class="font-bold"></small>
            </div>
          </div>
        ...
        >
          <div class="relative overflow-hidden">
            ...
            >
              <i class="uil uil-clock align-middle mr-1"></i>
              <small id="auction-item-5" class="font-bold"></small>
            </div>
          </div>
    ...
    <div class="container md:mt-24 mt-16">
      ...
      <div
        class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-10 gap-[30px]"
      >
        <div
          class="
            flex
        ...
        >
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <a
                ...
                >Steven Townsend</a
              >
              <span class="text-slate-400 text-sm block mt-0.5"
                >@StreetBoy</span
              >
            </div>
          </div>
          ...
          <a
            ...
            class="
              ...
              hover:text-white
            "
            ><i class="uil uil-user-plus text-[20px]"></i
          ></a>
        </div>
        <!--end content-->
