        ...
        <div class="relative md:py-24 py-16">
            <div class="container">
                    ...
                    <div class="filters-group-wrap text-center">
                        <div class="filters-group">
                            <ul class="mb-0 list-none container-filter-box filter-options">
                                <li class="inline-block font-medium text-base mx-1.5 mb-3 py-1 px-3 cursor-pointer relative text-slate-400 border border-gray-100 dark:border-gray-700 rounded-full transition duration-500 active" data-group="all"><i class="uil uil-browser"></i>  All</li>
                                <li class="inline-block font-medium text-base mx-1.5 mb-3 py-1 px-3 cursor-pointer relative text-slate-400 border border-gray-100 dark:border-gray-700 rounded-full transition duration-500" data-group="games"><i class="uil uil-volleyball"></i> Games</li>
                                <li class="inline-block font-medium text-base mx-1.5 mb-3 py-1 px-3 cursor-pointer relative text-slate-400 border border-gray-100 dark:border-gray-700 rounded-full transition duration-500" data-group="art"><i class="uil uil-chart-pie-alt"></i> Art</li>
                                <li class="inline-block font-medium text-base mx-1.5 mb-3 py-1 px-3 cursor-pointer relative text-slate-400 border border-gray-100 dark:border-gray-700 rounded-full transition duration-500" data-group="music"><i class="uil uil-music"></i> Music</li>
                                <li class="inline-block font-medium text-base mx-1.5 mb-3 py-1 px-3 cursor-pointer relative text-slate-400 border border-gray-100 dark:border-gray-700 rounded-full transition duration-500" data-group="video"><i class="uil uil-camera-plus"></i> Video</li>
                                <li class="inline-block font-medium text-base mx-1.5 mb-3 py-1 px-3 cursor-pointer relative text-slate-400 border border-gray-100 dark:border-gray-700 rounded-full transition duration-500" data-group="memes"><i class="uil uil-rocket"></i> Memes</li>
                            </ul>
                        </div>
                    </div>
                </div><!--grid-->
                ...
                <div id="grid" class="md:flex justify-center mx-auto mt-4">
                    <div class="lg:w-1/4 md:w-1/3 p-3 picture-item" data-groups='["games"]'>
                    ...
                    <div class="lg:w-1/4 md:w-1/3 p-3 picture-item" data-groups='["art"]'>
                        <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                            <div class="relative overflow-hidden">
                                <div class="relative overflow-hidden rounded-lg">
                    ...
                    <div class="lg:w-1/4 md:w-1/3 p-3 picture-item" data-groups='["music", "memes"]'>
                        <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                            <div class="relative overflow-hidden">
                                <div class="relative overflow-hidden rounded-lg">
                    ...
                    <div class="lg:w-1/4 md:w-1/3 p-3 picture-item" data-groups='["video"]'>
                        <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                            <div class="relative overflow-hidden">
                                <div class="relative overflow-hidden rounded-lg">
                    ...
                    <div class="lg:w-1/4 md:w-1/3 p-3 picture-item" data-groups='["memes", "video"]'>
                        <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                            <div class="relative overflow-hidden">
                                <div class="relative overflow-hidden rounded-lg">
                    ...
                    <div class="lg:w-1/4 md:w-1/3 p-3 picture-item" data-groups='["music"]'>
                        <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                            <div class="relative overflow-hidden">
                                <div class="relative overflow-hidden rounded-lg">
                    ...
                    <div class="lg:w-1/4 md:w-1/3 p-3 picture-item" data-groups='["memes", "video"]'>
                        <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                            <div class="relative overflow-hidden">
                                <div class="relative overflow-hidden rounded-lg">
                                    <img src="assets/images/items/8.jpg" class="rounded-lg shadow-md dark:shadow-gray-700 group-hover:scale-110 transition-all duration-500" alt="">
                                </div>
                            ...
                            <div class="mt-3">
                                <div class="flex items-center">
                                    <img src="assets/images/avatar/7.jpg" class="rounded-full h-8 w-8" alt="">
                                    <a href="creator-profile.html" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@LooserBad</a>
                                </div>

                                <div class="my-3">
                                    <a href="item-detail.html" class="font-semibold hover:text-violet-600">Umber Arrow</a>
                                </div>
                    ...
                    <div class="lg:w-1/4 md:w-1/3 p-3 picture-item" data-groups='["art"]'>
                        <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                            <div class="relative overflow-hidden">
                                <div class="relative overflow-hidden rounded-lg">
                                    <img src="assets/images/items/4.gif" class="rounded-lg shadow-md dark:shadow-gray-700 group-hover:scale-110 transition-all duration-500" alt="">
                                </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="my-3">
                                    <a href="item-detail.html" class="font-semibold hover:text-violet-600">Gloam Druid</a>
                                </div>
                    ...
                    <div class="lg:w-1/4 md:w-1/3 p-3 picture-item" data-groups='["games"]'>
                        <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                            <div class="relative overflow-hidden">
                                <div class="relative overflow-hidden rounded-lg">
                                    <img src="assets/images/items/5.gif" class="rounded-lg shadow-md dark:shadow-gray-700 group-hover:scale-110 transition-all duration-500" alt="">
                                </div>
                            ...
                            <div class="mt-3">
                                <div class="flex items-center">
                                    <img src="assets/images/avatar/8.jpg" class="rounded-full h-8 w-8" alt="">
                                    <a href="creator-profile.html" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@PandaOne</a>
                                </div>

                                <div class="my-3">
                                    <a href="item-detail.html" class="font-semibold hover:text-violet-600">Azuki #7421</a>
                                </div>
                    ...
                    <div class="lg:w-1/4 md:w-1/3 p-3 picture-item" data-groups='["music"]'>
                        <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                            <div class="relative overflow-hidden">
                                <div class="relative overflow-hidden rounded-lg">
                                    <img src="assets/images/items/9.jpg" class="rounded-lg shadow-md dark:shadow-gray-700 group-hover:scale-110 transition-all duration-500" alt="">
                                </div>
                            ...
                            <div class="mt-3">
                                <div class="flex items-center">
                                    <img src="assets/images/items/2.gif" class="rounded-full h-8 w-8" alt="">
                                    <a href="creator-profile.html" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@FunnyGuy</a>
                                </div>

                                <div class="my-3">
                                    <a href="item-detail.html" class="font-semibold hover:text-violet-600">Wolf-Cult Vanguard</a>
                                </div>
