<template>
    <!-- Start Hero -->
        <div class="relative md:pb-24 pb-16 lg:mt-24 mt-[74px]">
            <div class="lg:container container-fluid">
                <div class="group profile-banner relative overflow-hidden text-transparent lg:rounded-xl shadow dark:shadow-gray-700">
                    <input id="pro-banner" name="profile-banner" type="file" class="hidden" onchange="loadFile(event)" />
                    <div class="relative shrink-0">
                        <img src="assets/images/blog/single.jpg" class="h-80 w-full object-cover" id="profile-banner" alt="">
                    ...
                    <div class="md:w-full">
                        <div class="relative -mt-[60px] text-center">
                            <div class="group profile-pic w-[112px] mx-auto">
                                ...
                                <div>
                                    <div class="relative h-28 w-28 mx-auto rounded-full shadow dark:shadow-gray-800 ring-4 ring-slate-50 dark:ring-slate-800 overflow-hidden">
                                        <img src="assets/images/avatar/1.jpg" class="rounded-full" id="profile-image" alt="">
                            ...
                            <div class="mt-6">
                                <h5 class="text-xl font-semibold">Jenny Jimenez <i class="mdi mdi-check-decagram text-emerald-600 align-middle text-lg"></i></h5>
                                <p class="text-slate-400 text-[16px] mt-1">Created by <a href="" class="text-violet-600 font-semibold">1x5484dcdvcdscds56c4</a></p>

                                <div class="mt-4">
                                    <a href="javascript:void(0)" class="btn btn-sm rounded-full bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white"><i class="mdi mdi-plus"></i> Follow me</a>
                                    <a href="javascript:void(0)" class="btn btn-icon btn-sm rounded-full bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white"><i class="mdi mdi-account-plus"></i></a>
                                    <a href="creator-profile-edit.html" class="btn btn-icon btn-sm rounded-full bg-violet-600/5 hover:bg-violet-600 border-violet-600/10 hover:border-violet-600 text-violet-600 hover:text-white"><i class="mdi mdi-cog"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
