  ...
  <div class="relative md:py-24 py-16">
    ...
    <div class="container md:mt-24 mt-16">
      <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
        ...
        <div
          class="lg:col-span-5 md:col-span-6 mt-8 md:mt-0 order-2 md:order-1"
        >
          <div class="lg:mr-5">
            <div
              class="
              ...
              "
            >
              <h3 class="mb-6 text-2xl leading-snug font-medium">
                Get in touch !
              </h3>
                  ...
                  <div class="lg:col-span-6 mb-5">
                    <div class="text-left">
                      ...
                      <input
                        ...
                        id="name"
                        type="text"
                        class="form-input text-[15px] rounded-full mt-2"
                        placeholder="Name :"
                      />
                    </div>
                  </div>
                  ...
                  <div class="mb-5">
                    <div class="text-left">
                      ...
                      <textarea
                        name="comments"
                        id="comments"
                        class="form-input text-[15px] rounded-2xl h-28 mt-2"
                        placeholder="Message :"
                      ></textarea>
                    </div>
                  </div>
